        ...
        data() {
            return {
                emoji: [
                    {
                        name: "angry",
                        img: require("@/assets/emoji/angry.svg")
                    },
                    {
                        name: "disgust",
                        img: require("@/assets/emoji/disgust.svg")
                    },
                    {
                        name: "fear",
                        img: require("@/assets/emoji/fear.svg")
                    },
                    {
                        name: "joy",
                        img: require("@/assets/emoji/joy.svg")
                    },
                    {
                        name: "sadness",
                        img: require("@/assets/emoji/sadness.svg")
                    }
                ],
                svg: {
                    totalWidth: 400,
